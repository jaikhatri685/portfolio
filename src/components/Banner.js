    ...
    <div className=" pt-48 lg:pt-20 pb-32  inter z-0 relative banner">
      <div className="flex  flex-col md:flex-row md:justify-between items-center w-full">
        <div className="w-full md:w-1/2 px-16">
          ...
          <h1 className="text-left font-bold text-6xl mb-4 tracking-wider">
            Hi I 'm Jai <span> {text}</span>{" "}
          </h1>
          <p className="text-justify text-lg leading-7 tracking-wider mb-4" style={{color:"#B8B8B8"}}>
            I am pre-final year Computer Science Undergraduate student at BITS
            Goa. I have keen interest in Frontend WebD and Data Analysis. I also
            love travelling, gymming and learning about finance.
          </p>
